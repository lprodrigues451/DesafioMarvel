...
const val EMAIL_ERROR = "Favor informar email"
const val PASSWORD_ERROR = "Favor informar senha"
const val NAME_ERROR = "Favor informar nome"
const val NAME_FULL = "Por favor informe seu nome completo"
const val PASSWORD_EIGHT = "Senha tem que ter no minimo 8 caracteres"
const val UNABLE_TO_LOGIN = "Não foi possivel realizar o login!"
const val UNABLE_TO_REGISTRE = "Não foi possível realizar o registro!"
